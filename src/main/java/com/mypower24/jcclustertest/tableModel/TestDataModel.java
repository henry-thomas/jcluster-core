...
public class TestDataModel extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TestDataModel
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestDataModel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestDataModel().setVisible(true);
            }
        });
    }
